...
* [[`082c0685a8`](https://github.com/nodejs/node/commit/082c0685a8)] - **build**: document targets in the Makefile (Joyee Cheung) [#16975](https://github.com/nodejs/node/pull/16975)
...
* [[`983b028ed4`](https://github.com/nodejs/node/commit/983b028ed4)] - **deps**: cherry-pick 50f7455 from upstream V8 (Michaël Zasso) [#16591](https://github.com/nodejs/node/pull/16591)
...
* [[`d3544fd155`](https://github.com/nodejs/node/commit/d3544fd155)] - **doc**: fix incorrect argument type in fs.readSync (Mykola Bilochub) [#18022](https://github.com/nodejs/node/pull/18022)
* [[`f384f731da`](https://github.com/nodejs/node/commit/f384f731da)] - **doc**: compact eslint directives in common/README (Vse Mozhet Byt) [#17971](https://github.com/nodejs/node/pull/17971)
* [[`3bbcf26819`](https://github.com/nodejs/node/commit/3bbcf26819)] - **doc**: add guide on maintaining build files (Joyee Cheung) [#16975](https://github.com/nodejs/node/pull/16975)
* [[`f37a3cc77a`](https://github.com/nodejs/node/commit/f37a3cc77a)] - **doc**: re-alphabetise sections in common/README.md (Vse Mozhet Byt) [#17971](https://github.com/nodejs/node/pull/17971)
* [[`080e6d1f7a`](https://github.com/nodejs/node/commit/080e6d1f7a)] - **doc**: fix code nits in common/README (Vse Mozhet Byt) [#17971](https://github.com/nodejs/node/pull/17971)
* [[`f71feb1fc7`](https://github.com/nodejs/node/commit/f71feb1fc7)] - **doc**: fix link for https api change (Myles Borins) [#17630](https://github.com/nodejs/node/pull/17630)
* [[`ab17d848d5`](https://github.com/nodejs/node/commit/ab17d848d5)] - **doc**: correct spelling (sreepurnajasti) [#17911](https://github.com/nodejs/node/pull/17911)
* [[`2e673e9f87`](https://github.com/nodejs/node/commit/2e673e9f87)] - **doc**: grammar fixes in http2.md (Rich Trott) [#17972](https://github.com/nodejs/node/pull/17972)
* [[`4d7088e968`](https://github.com/nodejs/node/commit/4d7088e968)] - **doc**: add docs for common/http2.js utility (James M Snell) [#17942](https://github.com/nodejs/node/pull/17942)
...
* [[`4dc53f5c94`](https://github.com/nodejs/node/commit/4dc53f5c94)] - **fs**: guarantee order of callbacks in ws.close (Matteo Collina) [#18002](https://github.com/nodejs/node/pull/18002)
...
* [[`1b12785e2d`](https://github.com/nodejs/node/commit/1b12785e2d)] - **http2**: use aliased buffer for perf stats, add stats (James M Snell) [#18020](https://github.com/nodejs/node/pull/18020)
* [[`3dd59e1814`](https://github.com/nodejs/node/commit/3dd59e1814)] - **http2**: verify flood error and unsolicited frames (James M Snell) [#17969](https://github.com/nodejs/node/pull/17969)
* [[`0f885149c3`](https://github.com/nodejs/node/commit/0f885149c3)] - **http2**: verify that a dependency cycle may exist (James M Snell) [#17968](https://github.com/nodejs/node/pull/17968)
* [[`101e41e618`](https://github.com/nodejs/node/commit/101e41e618)] - **http2**: implement maxSessionMemory (James M Snell) [#17967](https://github.com/nodejs/node/pull/17967)
* [[`287d1adeaf`](https://github.com/nodejs/node/commit/287d1adeaf)] - **http2**: properly handle already closed stream error (James M Snell) [#17942](https://github.com/nodejs/node/pull/17942)
* [[`9a2b332294`](https://github.com/nodejs/node/commit/9a2b332294)] - **http2**: add aligned padding strategy (James M Snell) [#17938](https://github.com/nodejs/node/pull/17938)
* [[`7d31a7eac2`](https://github.com/nodejs/node/commit/7d31a7eac2)] - **http2**: add initial support for originSet (James M Snell) [#17935](https://github.com/nodejs/node/pull/17935)
* [[`930dd8ec23`](https://github.com/nodejs/node/commit/930dd8ec23)] - **http2**: add altsvc support (James M Snell) [#17917](https://github.com/nodejs/node/pull/17917)
* [[`b46153bd42`](https://github.com/nodejs/node/commit/b46153bd42)] - **http2**: strictly limit number on concurrent streams (James M Snell) [#16766](https://github.com/nodejs/node/pull/16766)
* [[`b19d41bf86`](https://github.com/nodejs/node/commit/b19d41bf86)] - **http2**: perf_hooks integration (James M Snell) [#17906](https://github.com/nodejs/node/pull/17906)
* [[`27c11c16a5`](https://github.com/nodejs/node/commit/27c11c16a5)] - **http2**: remove duplicate words in comments (Tobias Nießen) [#17939](https://github.com/nodejs/node/pull/17939)
* [[`e640e34a77`](https://github.com/nodejs/node/commit/e640e34a77)] - **http2**: implement ref() and unref() on client sessions (Kelvin Jin) [#17620](https://github.com/nodejs/node/pull/17620)
* [[`5a42bc5ba2`](https://github.com/nodejs/node/commit/5a42bc5ba2)] - **http2**: keep session objects alive during Http2Scope (Anna Henningsen) [#17863](https://github.com/nodejs/node/pull/17863)
* [[`8429112007`](https://github.com/nodejs/node/commit/8429112007)] - **http2**: fix compiling with `--debug-http2` (Anna Henningsen) [#17863](https://github.com/nodejs/node/pull/17863)
* [[`098edcb196`](https://github.com/nodejs/node/commit/098edcb196)] - **http2**: convert Http2Settings to an AsyncWrap (James M Snell) [#17763](https://github.com/nodejs/node/pull/17763)
* [[`69cea36a51`](https://github.com/nodejs/node/commit/69cea36a51)] - **http2**: refactor outgoing write mechanism (Anna Henningsen) [#17718](https://github.com/nodejs/node/pull/17718)
* [[`c434057dff`](https://github.com/nodejs/node/commit/c434057dff)] - **http2**: remove redundant write indirection (Anna Henningsen) [#17718](https://github.com/nodejs/node/pull/17718)
* [[`2fb884dbee`](https://github.com/nodejs/node/commit/2fb884dbee)] - **http2**: cleanup Http2Stream/Http2Session destroy (James M Snell) [#17406](https://github.com/nodejs/node/pull/17406)
* [[`2e11cdaf79`](https://github.com/nodejs/node/commit/2e11cdaf79)] - **http2**: be sure to destroy the Http2Stream (James M Snell) [#17406](https://github.com/nodejs/node/pull/17406)
* [[`fe5ec8e8b2`](https://github.com/nodejs/node/commit/fe5ec8e8b2)] - **http2**: only schedule write when necessary (Anna Henningsen) [#17183](https://github.com/nodejs/node/pull/17183)
* [[`d6785410ec`](https://github.com/nodejs/node/commit/d6785410ec)] - **http2**: don't call into JS from GC (Anna Henningsen) [#17183](https://github.com/nodejs/node/pull/17183)
...
* [[`5d7eb3d3c8`](https://github.com/nodejs/node/commit/5d7eb3d3c8)] - **lib**: enable dot-notation eslint rule (Anatoli Papirovski) [#18007](https://github.com/nodejs/node/pull/18007)
...
* [[`89233a7f9e`](https://github.com/nodejs/node/commit/89233a7f9e)] - **perf_hooks**: fix scheduling regression (Anatoli Papirovski) [#18051](https://github.com/nodejs/node/pull/18051)
...
* [[`30273d400c`](https://github.com/nodejs/node/commit/30273d400c)] - **repl**: show lexically scoped vars in tab completion (Michaël Zasso) [#16591](https://github.com/nodejs/node/pull/16591)
...
* [[`b1912858ba`](https://github.com/nodejs/node/commit/b1912858ba)] - **src**: update make for new code coverage locations (Michael Dawson) [#17987](https://github.com/nodejs/node/pull/17987)
* [[`6ad25d9c0c`](https://github.com/nodejs/node/commit/6ad25d9c0c)] - **src**: remove duplicate words in comments (Tobias Nießen) [#17939](https://github.com/nodejs/node/pull/17939)
* [[`6cbe1b0019`](https://github.com/nodejs/node/commit/6cbe1b0019)] - **src**: silence http2 -Wunused-result warnings (cjihrig) [#17954](https://github.com/nodejs/node/pull/17954)
* [[`5f059dfbe4`](https://github.com/nodejs/node/commit/5f059dfbe4)] - **src**: add optional keep-alive object to SetImmediate (Anna Henningsen) [#17183](https://github.com/nodejs/node/pull/17183)
...
* [[`1e5571ffa9`](https://github.com/nodejs/node/commit/1e5571ffa9)] - **timers**: make setImmediate() immune to tampering (Ben Noordhuis) [#17736](https://github.com/nodejs/node/pull/17736)
...
* [[`647e01d913`](https://github.com/nodejs/node/commit/647e01d913)] - **tls**: set servername on client side too (James M Snell) [#17935](https://github.com/nodejs/node/pull/17935)
...
* [[`371b230db5`](https://github.com/nodejs/node/commit/371b230db5)] - **tools**: do not override V8's gitignore (Yang Guo) [#18010](https://github.com/nodejs/node/pull/18010)
...
* [[`b89cda4cbd`](https://github.com/nodejs/node/commit/b89cda4cbd)] - **tools**: fix AttributeError: __exit__ on Python 2.6 (Dmitriy Kasyanov) [#17663](https://github.com/nodejs/node/pull/17663)
...
* [[`366ede87ae`](https://github.com/nodejs/node/commit/366ede87ae)] - **trace_events**: stop tracing agent in process.exit() (Andreas Madsen) [#18005](https://github.com/nodejs/node/pull/18005)
